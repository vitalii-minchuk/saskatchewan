...
<template>
  <v-btn @click="pdfRef.print()">print</v-btn>
  <v-btn @click="pdfRef.download()">download</v-btn>
  <v-btn @click="increaseScale">Zoom In</v-btn>
  <v-btn @click="decreaseScale">Zoom Out</v-btn>
  <VuePdfEmbed
    :key="scale"
    ref="pdfRef"
    annotation-layer
